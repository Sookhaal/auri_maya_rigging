...
class Controller(RigController):
    ...
    def prebuild(self):
        ...
        hip_guide.setAttr("translate", (2 * self.side_coef, 7, -1))
        knee_guide.setAttr("translate", (2 * self.side_coef, 4.5, 0))
        knee_02_guide.setAttr("translate", (2 * self.side_coef, 3, -2))
        ankle_guide.setAttr("translate", (2 * self.side_coef, 1, -1))
    ...
    def create_local_spaces(self):
        ...
        if len(self.model.space_list) > 0:
            ...
            for i, space in enumerate(self.model.space_list):
                ...
                fk_space_const = pmc.orientConstraint(space_locs[i], self.created_ctrtl_jnts[0].getParent(), maintainOffset=0)
                ...
                rig_lib.connect_condition_to_constraint("{0}.{1}W{2}".format(fk_space_const, space_locs[i], i),
                                                        ...
                                                        "{0}_{1}_COND".format(self.created_ctrtl_jnts[0], spaces_names[i]),
                ...
                rig_lib.connect_condition_to_constraint("{0}.{1}W{2}".format(ik_space_const, space_locs[i], i),
                                                        ...
                                                        "{0}_{1}_COND".format(self.created_ik_ctrls[0], spaces_names[i]))
    ...
    def clean_rig(self):
        ...
        rig_lib.add_parameter_as_extra_attr(info_crv, "Module", "quadruped_back_leg")
